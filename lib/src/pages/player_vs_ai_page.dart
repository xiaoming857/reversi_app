...
class PlayerVsAiPage extends StatefulWidget {
  @override
  _PlayerVsAiPageState createState() => _PlayerVsAiPageState();
}


class _PlayerVsAiPageState extends State<PlayerVsAiPage> {
