...
class PlayerVsPlayerPage extends StatefulWidget {
  @override
  _PlayerVsPlayerPageState createState() => _PlayerVsPlayerPageState();
}


class _PlayerVsPlayerPageState extends State<PlayerVsPlayerPage> {
